...
The current situation in Palestine and how USA 🇺🇸 based social media are reacting to it (by silencing opposing voices, shadow banning, etc.) is quite alerting. It got me to start doing concrete actions to cut as many ties with companies supporting the genocide (either directly or indirectly) while trying to escape the surveillance bubble (aka Surveillance Capitalism) while at it.
